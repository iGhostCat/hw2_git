...
@pytest.mark.parametrize('input_str, expected', [('Maestro 1596837868705199', '1596 83** **** 5199'),
...
@pytest.mark.parametrize('date_iso, expected_date', [('2019-07-03T18:35:29.512364', '03.07.2019'),
